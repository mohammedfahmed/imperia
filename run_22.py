...
default_p_radio = dict(f_Hz= 600e6, ERP_W=35,  txh_m = 2, rxh_m=2)
default_p_a2g = dict(f_Hz= 2e9, ERP_W=35, txh_m = 500, rxh_m=2)
...
def signalserver_pathloss(tx,rx,p=default_p_radio):
    ...
    out = subprocess.check_output(["/home/ubuntu/Software/Signal-Server/signalserverHD", "-m","-dbm",
                             ...
                             "-erp", str(ERP_W),
                             "-f", str(f_MHz),
                             "-pm", "1", # 1: ITM, 2: LOS, 3: Hata, 4: ECC33, 5: SUI, 6: COST-Hata, 7: FSPL, 8: ITWOM, 9: Ericsson, 10: Plane earth, 11: Egli VHF/UHF
                             "-txh", "2",
                             "-rxh", "2",
                             "-lat", str(tx.latitude),
                             "-lon", str(tx.longitude),
                             "-rla", str(rx.latitude),
                             "-rlo", str(rx.longitude)],cwd=ssdir)
...
if __name__ == "__main__":
    ...
    with open_22():
        ...
        coordinates = [( 35.0433, 32.8119), (35.107, 33.018947), (35.532089, 32.794592), (35.0433, 32.8119)]
